...
public class WeightedQuickUnionFindLargest {
    private int count;
    private int[] storage;
    private int[] size;
    private HashMap<Integer, Integer> largest;

    public WeightedQuickUnionFindLargest(int n) {
        count = n;
        storage = new int[n];
        size = new int[n];
        largest = new HashMap<>();
    ...
    public static void main(String[] args) {
        WeightedQuickUnionFindLargest wqu = new WeightedQuickUnionFindLargest(10);
        wqu.union(0, 2);
        wqu.union(8, 4);
